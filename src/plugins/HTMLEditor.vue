...
const templates = {
  ...
  'Code': `<div style="height: 100%; display: flex; flex-direction: column; padding: 4rem; box-sizing: border-box;">\n  <h1 style="font-size: 2.5rem;">Title</h1>\n<pre><code class="language-js">// this is a code block!\nconsole.log('Hello, world!')\n</code></pre>\n</div>\n\n\x3C!-- highlight.js dependency -->\n<link rel="stylesheet" href="//cdn.jsdelivr.net/gh/highlightjs/cdn-release@11.7.0/build/styles/default.min.css">\n\x3Cscript src="//cdn.jsdelivr.net/gh/highlightjs/cdn-release@11.7.0/build/highlight.min.js">\x3C/script>\n\x3Cscript src="//cdn.jsdelivr.net/npm/highlightjs-line-numbers.js@2.8.0/dist/highlightjs-line-numbers.min.js">\x3C/script>\n\x3Cscript>setTimeout(() => { hljs.highlightAll(); hljs.initLineNumbersOnLoad() }, 100)\x3C/script>\n<style>.hljs-ln-numbers { user-select: none; color: #ccc; border-right: 1px solid #CCC; padding-right: 5px !important; }\n.hljs-ln-code { padding-left: 10px !important; }</style>`
}
let html = $ref('')
sendOut({ ready: 1 })
